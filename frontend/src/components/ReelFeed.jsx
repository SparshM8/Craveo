  ...
  return (
    <div className="reels-page">
      <header className="reels-header">
        <BrandMark compact />
        <span className="reels-header__tagline">Taste something new</span>
      </header>
        ...
        {items.length === 0 && (
          <div className="empty-state">
            <div className="empty-state__content">
              <BrandMark />
              <p>{emptyMessage}</p>
              <span>Fresh bites and local favorites are on the way.</span>
            </div>
          </div>
        )}
          ...
          <section key={item._id} className="reel" role="listitem">
            ...
            <div className="reel-overlay">
              ...
              <div className="reel-content">
                ...
                {item.foodPartner && (
                  <Link className="reel-btn" to={"/food-partner/" + item.foodPartner} aria-label="View food spot">View spot</Link>
                )}
              </div>
            </div>
          </section>
